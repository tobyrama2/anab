...
$random_name = "A "." ".substr(str_shuffle("abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ"), 0, 4);
...
$data_create = '{"address":"","birthDate":"1991-10-11","debug":false,"deviceId":'.$deviceid2.',"email":'.$random_email.',"firstName":"","fullName":'.$random_name.',"gender":"F","lastName":"","latitude":0,"longitude":0,"maritalStatus":"M","password":"14116228","phone":'.$nomorhp.',"postCode":"","registerPonta":true,"token":'.$token2.'}';
...
if($status_create !== "00"){
    ...
    echo "| Sukses daftar!!! \n";
    echo "| Nomer hp $no_hp dan password 14116228 \n";
    echo "| Member Ponta $id_ponta \n";
    echo "| Loading voucher \n";
    sleep(4);
    $arr1 = ["token"=>$token,"id"=>$memberid, "hp"=>$no_hp];
    file_put_contents("$no_hp.json",json_encode($arr1));
